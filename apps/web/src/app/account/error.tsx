...
/** Per-section error boundary for /account/* — see admin/error.tsx for rationale. */
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <p className="mb-4 max-w-md text-sm text-gray-500 dark:text-slate-400">
        We hit an unexpected error loading this account page. Try again, or refresh the browser if the problem persists.
      </p>
      <button
        type="button"
        onClick={reset}
