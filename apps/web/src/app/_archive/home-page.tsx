    ...
    <div className="relative min-h-screen bg-jadwal-bg font-outfit">
      ...
      <section className="relative overflow-hidden min-h-svh flex flex-col">
        ...
        <div dir="ltr" className="absolute inset-0 z-5 pointer-events-none overflow-hidden">
          ...
          {/* Clouds 4 + 5 are the smallest/faintest — `hidden sm:block` keeps
              the mobile hero to 3 clouds (1–3 above) to cut DOM + paint cost on
              phones; desktop (≥640px) still gets all 5. */}
          <div className="hero-cloud-slow absolute top-[28%] left-[25%] hidden sm:block">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/images/userhero/cloud.svg"
              alt=""
          ...
          <div className="hero-cloud-mid absolute top-[4%] left-[35%] hidden sm:block">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/images/userhero/cloud.svg"
              alt=""
