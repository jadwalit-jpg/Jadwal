...
/** Per-section error boundary for /bookings/* — see admin/error.tsx for rationale. */
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <h2 className="mb-2 text-xl font-semibold text-gray-900 dark:text-white">
        Bookings section error
      </h2>
      <p className="mb-4 max-w-md text-sm text-gray-500 dark:text-slate-400">
        We hit an unexpected error loading this booking page. Try again, or refresh the browser if the problem persists.
      </p>
      <button
        type="button"
        onClick={reset}
