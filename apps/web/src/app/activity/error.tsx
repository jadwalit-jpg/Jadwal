...
/** Per-section error boundary for /activity/* — see admin/error.tsx for rationale. */
  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      ...
      <p className="mb-4 max-w-md text-sm text-gray-500 dark:text-slate-400">
        Something went wrong while loading this activity. Try again, or pick a different one from the catalog.
      </p>
      <button
        type="button"
        onClick={reset}
