...
/** Must match the `duration-300` below, or the prompt is cut off mid-exit. */
...
export function PushPrompt() {
  ...
  // CSS transition instead of <AnimatePresence>. This component is dynamically
  // imported by CustomerShell on EVERY customer route, so importing
  // framer-motion here pulled 119 KB of it (39 KB transfer, ~90% unused per
  // Lighthouse) onto every page a customer visits — for one fade-and-slide.
  // #594 removed the library from the root layout; this was the remaining path.
