 ...
 *
 * The pixel is loaded by <MetaPixel> ONLY after the visitor accepts cookies —
 * see components/meta-pixel.tsx + context/cookie-consent.tsx.
 */
 ...
 * customer flow: it no-ops until the pixel is actually loaded, which only
 * happens after cookie consent. So a visitor who declined cookies is never
 * tracked, and callers don't need to know the consent state.
 */
